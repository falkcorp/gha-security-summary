...
<!-- version: 1.1.0 -->
<!-- guid: 6e855d2d-8c09-450e-81e2-949165e63a9c -->
...
- All changes to security summary generation logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that generates security summaries from vulnerability scans and dependency audits.
