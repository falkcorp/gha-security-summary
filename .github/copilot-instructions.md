...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to security summary generation logic should be made in the
  embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that generates security
summaries from vulnerability scans and dependency audits.
