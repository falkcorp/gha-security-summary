...
This is the authoritative project instructions file for **gha-security-summary**
— a GHA composite action that summarizes security findings (CodeQL, Dependency
Review, Security Audit, Trivy) for GitHub Actions job summaries.
